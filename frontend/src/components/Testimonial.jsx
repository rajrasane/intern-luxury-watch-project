      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        <div className="lg:w-1/2 z-10 mt-8 lg:mt-0">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h4 className="font-roboto font-medium text-base text-[#2e2e2e] dark:text-[#f2f2f2] transition-colors duration-300">Lee Doe</h4>
              <p className="font-roboto font-normal text-sm text-[#595959] dark:text-[#bfbfbf] transition-colors duration-300">Director of a company</p>
            </div>
          </div>
