      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-8 mb-16">
          ...
          <div className="w-full lg:w-1/4">
            <h3 className="font-roboto font-medium text-xl text-[#2e2e2e] dark:text-white mb-6 transition-colors duration-300">Our information</h3>
            <p className="font-roboto font-normal text-base text-[#595959] dark:text-gray-400 leading-relaxed transition-colors duration-300">
          ...
          <div className="w-full lg:w-1/6">
            <h3 className="font-roboto font-medium text-xl text-[#2e2e2e] dark:text-white mb-6 transition-colors duration-300">About Us</h3>
            <ul className="space-y-4">
              <li><a href="#" className="font-roboto font-normal text-base text-[#595959] dark:text-gray-400 hover:text-[#2e2e2e] dark:hover:text-white transition-colors">Support Center</a></li>
              <li><a href="#" className="font-roboto font-normal text-base text-[#595959] dark:text-gray-400 hover:text-[#2e2e2e] dark:hover:text-white transition-colors">Customer Support</a></li>
              <li><a href="#" className="font-roboto font-normal text-base text-[#595959] dark:text-gray-400 hover:text-[#2e2e2e] dark:hover:text-white transition-colors">About Us</a></li>
              <li><a href="#" className="font-roboto font-normal text-base text-[#595959] dark:text-gray-400 hover:text-[#2e2e2e] dark:hover:text-white transition-colors">Copy Right</a></li>
            </ul>
          </div>

          {/* Product */}
          <div className="w-full lg:w-1/6">
            <h3 className="font-roboto font-medium text-xl text-[#2e2e2e] dark:text-white mb-6 transition-colors duration-300">Product</h3>
            <ul className="space-y-4">
              <li><a href="#" className="font-roboto font-normal text-base text-[#595959] dark:text-gray-400 hover:text-[#2e2e2e] dark:hover:text-white transition-colors">Road bikes</a></li>
              <li><a href="#" className="font-roboto font-normal text-base text-[#595959] dark:text-gray-400 hover:text-[#2e2e2e] dark:hover:text-white transition-colors">Mountain bikes</a></li>
              <li><a href="#" className="font-roboto font-normal text-base text-[#595959] dark:text-gray-400 hover:text-[#2e2e2e] dark:hover:text-white transition-colors">Electric</a></li>
              <li><a href="#" className="font-roboto font-normal text-base text-[#595959] dark:text-gray-400 hover:text-[#2e2e2e] dark:hover:text-white transition-colors">Accesories</a></li>
            </ul>
          </div>

          {/* Social */}
          <div className="w-full lg:w-1/6">
            <h3 className="font-roboto font-medium text-xl text-[#2e2e2e] dark:text-white mb-6 transition-colors duration-300">Social</h3>
