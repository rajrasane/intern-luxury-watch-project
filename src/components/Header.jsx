  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white shadow-md">
      <div className="max-w-screen-xl mx-auto h-16 flex items-center justify-between px-4">
        ...
        {/* Right side icons */}
        <div className="flex items-center gap-4"> {/* Changed space-x-4 to gap-4 for better control */}
          {/* Placeholder for Cart Icon */}
          <button className="p-1 rounded-full hover:bg-gray-200 transition-colors flex items-center justify-center" aria-label="Cart">
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden p-1 rounded-md hover:bg-gray-200 focus:outline-none flex items-center justify-center"
